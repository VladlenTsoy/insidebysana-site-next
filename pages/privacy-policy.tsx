...
const PrivacyPolicy: React.FC<Props> = ({categories}) => {
    return (
        <Layout categories={categories}>
            ...
            <div className="container text_pages">
                ...
                <p>
                    ...
                    закона «О персональных данных» от 2 июля 2019 года № ЗРУ-547 и определяет порядок
                    обработки персональных данных и меры по обеспечению безопасности персональных данных
                    Коденко Ляйсан Марселевна (далее – Оператор).
                </p>
                <ol>
                    <li>
                ...
                <ol>
                    <li>
                        ...
                        посредством отправки электронных писем или рассылки в мессенджерах.
                    </li>
                    <li>
                        ...
                        электронной почты{" "}
                        <a href="mailto:sana@insidebysana.uz" target="_blank" rel="noreferrer">
                            sana@insidebysana.uz
                        </a>{" "}
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <a href="https://insidebysana.uz/policies" target="_blank" rel="noreferrer">
                            https://insidebysana.uz/policies
                        </a>
                        .
                    </li>
                </ol>
